...
execute if score traitors system >= aliveT playerStatus run scoreboard players add aliveDe playerStatus 1
...
# Repeat the function
execute if entity @a[team=innocent] if score aliveT playerStatus < traitors system run function sitt:round_structure/assign_roles
