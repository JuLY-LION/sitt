...
give @s[scores={equipment=303}] lingering_potion{Potion:"minecraft:long_regeneration"} 1

# (303) summon area_effect_cloud ~4 ~0 ~4 {Particle:"ambient_entity_effect",ReapplicationDelay:30,Radius:3f,RadiusPerTick:0f,RadiusOnUse:-0.05f,Duration:6000,DurationOnUse:0f,Age:0,WaitTime:0,Potion:"minecraft:healing"}
