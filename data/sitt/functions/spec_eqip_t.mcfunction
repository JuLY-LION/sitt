...
give @s[scores={equipment=102}] gunpowder{display:{Name:'{"text":"c4 placeholder","color":"red","italic":false}'}}
give @s[scores={equipment=103}] bow{Enchantments:[{id:"minecraft:flame",lvl:1s}]}
give @s[scores={equipment=104}] crossbow{Enchantments:[{id:"minecraft:multishot",lvl:1s},{id:"minecraft:quick_charge",lvl:1s}],ChargedProjectiles:[{id:"minecraft:arrow",Count:1b},{id:"minecraft:arrow",Count:1b},{id:"minecraft:arrow",Count:1b}],Charged:1b}
