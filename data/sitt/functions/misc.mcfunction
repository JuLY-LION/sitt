...
execute as @a[nbt={SelectedItem:{id:"minecraft:jigsaw",Count:1b,tag:{display:{Name:'{"text":"Radar","color":"blue","italic":false}'}}}},team=!traitor] run function sitt:radar
execute as @a[nbt={Inventory:[{id:"minecraft:jigsaw",Count:1b,Slot:-106b,tag:{display:{Name:'{"text":"Radar","color":"blue","italic":false}'}}}]},team=!traitor] run function sitt:radar
execute as @a[nbt={SelectedItem:{id:"minecraft:jigsaw",Count:1b,tag:{display:{Name:'{"text":"Radar","color":"blue","italic":false}'}}}},team=traitor] run function sitt:radar_t
execute as @a[nbt={Inventory:[{id:"minecraft:jigsaw",Count:1b,Slot:-106b,tag:{display:{Name:'{"text":"Radar","color":"blue","italic":false}'}}}]},team=traitor] run function sitt:radar_t
